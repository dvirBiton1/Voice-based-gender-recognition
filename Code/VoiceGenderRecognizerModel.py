...
class VoiceGenderRecognizerModel:
    ...
    def identify_gender(self):
        ...
        for i, vector in enumerate(test_only_features):
            ...
            is_male_score, is_female_score= -1*(is_male_score/(is_male_score+is_female_score)) ,(is_female_score/(is_male_score+is_female_score))*-1
            print(f"female score:{is_female_score} and male score: {is_male_score}")
            if i<gender_mid:
...
if __name__ == "__main__":
    gender_recognizer = VoiceGenderRecognizerModel("Train_to_Save/TrainingData/females", "Train_to_Save/TrainingData/males", "TestingData/females", "TestingData/males")
    # gender_recognizer = VoiceGenderRecognizerModel("TrainingData/females", "TrainingData/males","TestingData_2/females", "TestingData_2/males")
